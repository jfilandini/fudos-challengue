...
module Challenge
  module UseCases
    class ListProducts
      ...
      def call(requested_by_user_id:, page: 1, per_page: 20)
        ...
        result = @product_repository.paginate(limit: per_page, offset: (page - 1) * per_page, requested_by_user_id: requested_by_user_id)
